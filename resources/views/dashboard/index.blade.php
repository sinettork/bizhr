        ...
        <div class="col-lg-7">
            <div class="profile-card h-100 mb-0">
                ...
                <div class="profile-card-body p-0">
                    ...
                    @empty
                        <x-empty-state class="py-5 px-3" icon="fa-circle-check" tone="success" title="No open tasks" message="No open tasks are currently assigned to you." />
                    @endforelse
                </div>
            </div>
        </div>
