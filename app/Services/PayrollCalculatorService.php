...
class PayrollCalculatorService
{
    ...
    public function generate(PayrollPeriod $period, ?User $processor = null): int
    {
        return DB::transaction(function () use ($period, $processor): int {
            ...
            $period->update([
                'status' => 'processing',
                'processed_by' => $processor->id ?? $period->processed_by,
                'processed_at' => now(),
                'tax_rate_locked_at' => $period->tax_rate_locked_at ?: now(),
            ]);
            ...
            [
                ...
                'calculation_details' => [
                    ...
                    'statutory' => [
                        ...
                        'gdt_tax_rate_date' => $period->tax_rate_date ? CarbonImmutable::parse($period->tax_rate_date)->toDateString() : null,
     ...
     * @return array<string, array{paid: float, unpaid: float}>
     */
