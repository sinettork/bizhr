...
class LeaveRequestController extends Controller
{
    ...
    public function review(Request $request): View
    {
        ...
        $statistics = [
            ...
            'approved_today' => (clone $companyRequests)->where('status', 'approved')->whereDate('hr_reviewed_at', today())->count(),
            'rejected_today' => (clone $companyRequests)->where('status', 'rejected')->where(function (Builder $query): void {
