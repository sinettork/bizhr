...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('job_offers', function (Blueprint $table) {
            $table->id();
            $table->foreignId('job_applicant_id')->constrained()->restrictOnDelete();
            $table->decimal('salary_amount', 14, 2);
            $table->char('salary_currency', 3);
    ...
    {
        foreach (['announcements', 'expense_claims', 'asset_assignments', 'assets', 'training_enrollments', 'training_courses', 'job_offers', 'job_interviews', 'job_applicants', 'job_vacancies'] as $table) {
