...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'layouts.app','data' => ['title' => 'My Expenses & Claims']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'My Expenses & Claims']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.workspace-command-bar','data' => ['title' => 'My Expense Reimbursements','icon' => 'fa-money-bill-wave','context' => 'Personal Workspace']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'My Expense Reimbursements','icon' => 'fa-money-bill-wave','context' => 'Personal Workspace']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.list-actions','data' => ['addModal' => 'claimForm','addLabel' => 'Submit new claim']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['add-modal' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('claimForm'),'add-label' => 'Submit new claim']); ?>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $claims; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $claim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            ...
                            <td><span class="small text-body-secondary"><?php echo e(\Illuminate\Support\Str::limit($claim->business_purpose, 80)); ?></span></td>
...
<?php endif; ?>
    ...
    <div class="modal fade" id="claimForm" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <form class="modal-content" method="POST" enctype="multipart/form-data" action="<?php echo e(route('expenses.store')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body row g-3">
                    <div class="col-md-4">
                        ...
                        <input class="form-control" type="date" name="expense_date" max="<?php echo e(today()->format('Y-m-d')); ?>" required value="<?php echo e(today()->format('Y-m-d')); ?>">
                    </div>
                    <div class="col-md-4">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-save-actions','data' => ['saveLabel' => 'Submit claim for review']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['save-label' => 'Submit claim for review']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\www\bizhr\resources\views/expenses/mine.blade.php ENDPATH**/ ?>