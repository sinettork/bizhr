...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'layouts.app','data' => ['title' => 'My employment contracts']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'My employment contracts']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.workspace-command-bar','data' => ['title' => 'My employment contracts','icon' => 'fa-file-contract']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'My employment contracts','icon' => 'fa-file-contract']); ?>
...
<?php endif; ?>
    <div class="row g-3">
        <?php $__empty_1 = true; $__currentLoopData = $contracts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-lg-6"><article class="card h-100"><div class="card-body"><div class="d-flex justify-content-between gap-3"><div><div class="small text-body-secondary"><?php echo e($contract->contract_number); ?></div><h2 class="h5 mt-1 mb-0"><?php echo e(strtoupper($contract->type)); ?></h2></div><span class="badge text-bg-<?php echo e($contract->status === 'active' ? 'success' : 'secondary'); ?> align-self-start"><?php echo e(ucwords(str_replace('_', ' ', $contract->status))); ?></span></div><dl class="row small mt-4 mb-0"><dt class="col-5 text-body-secondary">Period</dt><dd class="col-7"><?php echo e($contract->start_date->format('d/m/Y')); ?> – <?php echo e($contract->end_date?->format('d/m/Y') ?? 'Open-ended'); ?></dd><dt class="col-5 text-body-secondary">Position</dt><dd class="col-7"><?php echo e($contract->position_title ?: '—'); ?></dd><dt class="col-5 text-body-secondary">Salary</dt><dd class="col-7"><?php echo e(number_format($contract->salary_amount, $contract->salary_currency === 'KHR' ? 0 : 2)); ?> <?php echo e($contract->salary_currency); ?></dd></dl><?php if($contract->document_path): ?><a class="btn btn-sm btn-primary mt-2" href="<?php echo e(route('contracts.download', $contract)); ?>"><i class="fa-solid fa-download me-1"></i>Download PDF</a><?php endif; ?></div></article></div>
...
<?php endif; ?>
<?php /**PATH D:\www\bizhr\resources\views\pages\employment-contracts\mine.blade.php ENDPATH**/ ?>