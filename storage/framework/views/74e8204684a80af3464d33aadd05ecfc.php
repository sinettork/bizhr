...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'layouts.app','data' => ['title' => 'My Performance Goals']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'My Performance Goals']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.workspace-command-bar','data' => ['title' => 'My Goals & Targets','icon' => 'fa-flag','context' => 'Personal Workspace']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'My Goals & Targets','icon' => 'fa-flag','context' => 'Personal Workspace']); ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $goals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $goal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            ...
                            <td class="fw-semibold text-primary">
                                <?php echo e($goal->employee_reported_value !== null ? $goal->employee_reported_value.' '.$goal->measurement_unit : '—'); ?>

                                <?php if($goal->employee_note): ?><div class="small text-body-secondary fst-italic"><?php echo e(\Illuminate\Support\Str::limit($goal->employee_note, 50)); ?></div><?php endif; ?>
                            </td>
                            ...
                            <td class="text-end pe-3 text-nowrap">
                                <?php if(in_array($goal->status, ['active','returned'])): ?>
                                    <button class="btn btn-action-link btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#updateGoal<?php echo e($goal->id); ?>">
...
<?php endif; ?>
    ...
    <?php $__currentLoopData = $goals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $goal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(in_array($goal->status, ['active','returned'])): ?>
            <div class="modal fade" id="updateGoal<?php echo e($goal->id); ?>" tabindex="-1">
                <div class="modal-dialog">
                    <form class="modal-content" method="POST" action="<?php echo e(route('performance.my-goals.update', $goal)); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="modal-header">
                            <h2 class="modal-title fs-5">Update Goal Progress · <?php echo e($goal->title); ?></h2>
                            <button class="btn-close" type="button" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                            <div class="mb-3 small">
                                <span class="text-body-secondary">Target:</span>
                                <strong><?php echo e($goal->target_value); ?> <?php echo e($goal->measurement_unit); ?></strong>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Achieved Value (<?php echo e($goal->measurement_unit); ?>) <span class="text-danger">*</span></label>
                                <input class="form-control" type="number" step=".01" name="employee_reported_value" value="<?php echo e(old('employee_reported_value', $goal->employee_reported_value)); ?>" required>
                            </div>
                            <div>
                                <label class="form-label">Evidence / Notes <span class="text-danger">*</span></label>
                                <textarea class="form-control" name="employee_note" rows="3" required placeholder="Describe progress and evidence..."><?php echo e(old('employee_note', $goal->employee_note)); ?></textarea>
                            </div>
                        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-save-actions','data' => ['saveLabel' => 'Submit progress']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['save-label' => 'Submit progress']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\www\bizhr\resources\views/performance/my-goals.blade.php ENDPATH**/ ?>