...
<head>
    ...
    <title><?php echo e($code); ?> — BizHR</title>
    <style>
        :root {
            color-scheme: light;
...
<body>
    <main class="card">
        <img class="logo" src="<?php echo e(asset('images/Artboard 5 copy.png')); ?>" alt="BizHR">
        <p class="code"><?php echo e($code); ?></p>
        <h1><?php echo e($title); ?></h1>
        <p><?php echo e($message); ?></p>
        <a href="<?php echo e(auth()->check() ? route('dashboard') : route('login')); ?>">
            <?php echo e(auth()->check() ? 'ត្រឡប់ទៅផ្ទាំងគ្រប់គ្រង' : 'ត្រឡប់ទៅចូលប្រើប្រាស់'); ?>

        </a>
    </main>
</body>
</html>
<?php /**PATH D:\www\bizhr\resources\views/errors/layout.blade.php ENDPATH**/ ?>