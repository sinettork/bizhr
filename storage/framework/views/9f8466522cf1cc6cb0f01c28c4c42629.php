...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'layouts.app','data' => ['title' => 'My Assets & Equipment']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'My Assets & Equipment']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.workspace-command-bar','data' => ['title' => 'My Assigned Equipment','icon' => 'fa-laptop','context' => 'Personal Workspace']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'My Assigned Equipment','icon' => 'fa-laptop','context' => 'Personal Workspace']); ?>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <tr>
                            <td class="ps-3 fw-medium text-dark"><?php echo e($assignment->asset?->asset_code); ?></td>
                            <td>
                                <div class="fw-semibold text-dark"><?php echo e($assignment->asset?->name); ?></div>
                                <?php if($assignment->asset?->serial_number): ?><small class="text-body-secondary">S/N: <?php echo e($assignment->asset->serial_number); ?></small><?php endif; ?>
                            </td>
                            <td><?php echo e($assignment->asset?->category ?? 'General'); ?></td>
                            <td><?php echo e($assignment->assigned_date->format('d M Y')); ?></td>
                            <td><?php echo e($assignment->expected_return_date?->format('d M Y') ?? 'Permanent'); ?></td>
                            <td><span class="badge text-bg-light border text-dark text-capitalize"><?php echo e($assignment->condition_out); ?></span></td>
                            <td>
                                <span class="badge text-bg-<?php echo e($isAssigned ? 'primary' : 'secondary'); ?>"><?php echo e(ucfirst($assignment->status)); ?></span>
                            </td>
                            <td class="text-end pe-3 text-nowrap">
                                <?php if($isAssigned): ?>
                                    <button class="btn btn-action-link btn-sm" data-bs-toggle="modal" data-bs-target="#return<?php echo e($assignment->id); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pagination-footer','data' => ['paginator' => $assignments]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
    ...
    <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($assignment->status === 'assigned'): ?>
            <div class="modal fade" id="return<?php echo e($assignment->id); ?>" tabindex="-1">
                <div class="modal-dialog">
                    <form class="modal-content" method="POST" action="<?php echo e(route('assets.receive', $assignment)); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="modal-header">
                            <h2 class="modal-title fs-5"><i class="fa-solid fa-rotate-left me-2 text-primary"></i>Return <?php echo e($assignment->asset?->name); ?></h2>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-save-actions','data' => ['saveLabel' => 'Record return']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['save-label' => 'Record return']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\www\bizhr\resources\views/assets/mine.blade.php ENDPATH**/ ?>