...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'layouts.app','data' => ['title' => 'My payslips']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'My payslips']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.workspace-command-bar','data' => ['title' => 'My payslips','icon' => 'fa-wallet','context' => 'Payroll']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'My payslips','icon' => 'fa-wallet','context' => 'Payroll']); ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            <td class="ps-3 fw-semibold">
                                <?php echo e($item->period?->name); ?>

                                <small class="d-block text-body-secondary"><?php echo e($item->period?->start_date?->format('d/m/Y')); ?> – <?php echo e($item->period?->end_date?->format('d/m/Y')); ?></small>
                            </td>
                            <td><?php echo e(strtoupper($item->currency) === 'KHR' ? number_format($item->base_salary, 0).' ៛' : '$'.number_format($item->base_salary, 2)); ?></td>
                            <td><?php echo e(number_format($item->overtime_hours, 2)); ?> h</td>
                            <td><?php echo e(strtoupper($item->currency) === 'KHR' ? number_format($deductions, 0).' ៛' : '$'.number_format($deductions, 2)); ?></td>
                            <td class="fw-semibold"><?php echo e(strtoupper($item->currency) === 'KHR' ? number_format($item->net_salary, 0).' ៛' : '$'.number_format($item->net_salary, 2)); ?></td>
                            <td><span class="badge text-bg-<?php echo e($item->payment_status === 'paid' ? 'success' : 'secondary'); ?>"><?php echo e($item->payment_status); ?></span></td>
                        </tr>
...
<?php endif; ?>
<?php /**PATH D:\www\bizhr\resources\views\payroll\payslips\index.blade.php ENDPATH**/ ?>